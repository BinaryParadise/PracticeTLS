...
class KeysGeneratorTests: XCTestCase {
    ...
    func testAESEncryptGCM() throws {
        let cipherData: [UInt8] = "00000000000000009dded924cac85dc23f173192bfba750556dd439f4f6cdb11187001a18c082a9f".uint8Array
        let preMasterSecret:[UInt8] = [0x03, 0x03, 0x3F, 0x0F, 0xDC, 0x01, 0xBF, 0x96, 0x48, 0x85, 0x68, 0xC0, 0x74, 0x3B, 0x78, 0x76, 0xC4, 0x89, 0x92, 0x4B, 0xAA, 0xDB, 0x5D, 0x63, 0xB6, 0xF2, 0x49, 0x13, 0xA5, 0x64, 0xF0, 0x44, 0xB8, 0xE5, 0x03, 0x06, 0x62, 0xC1, 0xAE, 0x4A, 0xA3, 0xD4, 0x73, 0x5E, 0x22, 0xB5, 0x8C, 0x22, ]
        let clientRandom:[UInt8] = "90358948742e774a8c7f32c85dfd8490549305480cead6f39980a51192050c47".uint8Array
        let serverRandom:[UInt8] = [0x26, 0xE9, 0xE5, 0x94, 0x70, 0xDA, 0xC8, 0x01, 0x87, 0x7D, 0x3F, 0xCF, 0x1C, 0xCE, 0x0F, 0x6F, 0x36, 0x0B, 0xE8, 0xF2, 0xF5, 0x79, 0xEA, 0x36, 0x00, 0xEF, 0xB0, 0xB1, 0xC5, 0xAA, 0x45, 0xB4, ]
        let readBulkKey:[UInt8] = [0x6D, 0xAA, 0xC0, 0xA3, 0x9B, 0x21, 0xB1, 0xB0, 0xC8, 0x50, 0xD8, 0xD7, 0x34, 0xBA, 0xA6, 0x1F, ]
        let readMacKey:[UInt8] = []
        let writeBulkKey:[UInt8] = [0xCF, 0x05, 0xD3, 0x3D, 0x88, 0x4B, 0x18, 0xE4, 0x9E, 0x92, 0x39, 0xEE, 0xC7, 0xFD, 0x21, 0x7B, ]
        let writeMacKey:[UInt8] = []
        let clientVerifyData:[UInt8] = []
